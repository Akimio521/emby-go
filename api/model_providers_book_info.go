...
// checks if the ProvidersBookInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvidersBookInfo{}

// ProvidersBookInfo struct for ProvidersBookInfo
...
func (o *ProvidersBookInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *ProvidersBookInfo) SetIndexNumberNil() {
...
func (o *ProvidersBookInfo) SetParentIndexNumberNil() {
...
func (o *ProvidersBookInfo) SetPremiereDateNil() {
...
func (o ProvidersBookInfo) MarshalJSON() ([]byte, error) {
...
func (o ProvidersBookInfo) ToMap() (map[string]interface{}, error) {
...
type NullableProvidersBookInfo struct {
	value *ProvidersBookInfo
	isSet bool
}

func (v NullableProvidersBookInfo) Get() *ProvidersBookInfo {
	return v.value
}

func (v *NullableProvidersBookInfo) Set(val *ProvidersBookInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableProvidersBookInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableProvidersBookInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProvidersBookInfo(val *ProvidersBookInfo) *NullableProvidersBookInfo {
	return &NullableProvidersBookInfo{value: val, isSet: true}
}

func (v NullableProvidersBookInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProvidersBookInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
