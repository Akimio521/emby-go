...
func (r ApiGetTrailersRequest) LocationTypes(locationTypes string) ApiGetTrailersRequest {
	r.locationTypes = &locationTypes
	return r
}

// Optional. If specified, results will be filtered based on LocationType. This allows multiple, comma delimeted.
func (r ApiGetTrailersRequest) ExcludeLocationTypes(excludeLocationTypes string) ApiGetTrailersRequest {
...
func (r ApiGetTrailersRequest) MinPremiereDate(minPremiereDate string) ApiGetTrailersRequest {
	r.minPremiereDate = &minPremiereDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetTrailersRequest) MinDateLastSaved(minDateLastSaved string) ApiGetTrailersRequest {
	r.minDateLastSaved = &minDateLastSaved
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetTrailersRequest) MinDateLastSavedForUser(minDateLastSavedForUser string) ApiGetTrailersRequest {
	r.minDateLastSavedForUser = &minDateLastSavedForUser
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetTrailersRequest) MaxPremiereDate(maxPremiereDate string) ApiGetTrailersRequest {
