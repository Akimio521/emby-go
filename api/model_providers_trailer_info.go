...
// checks if the ProvidersTrailerInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvidersTrailerInfo{}

// ProvidersTrailerInfo struct for ProvidersTrailerInfo
...
func (o *ProvidersTrailerInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *ProvidersTrailerInfo) SetIndexNumberNil() {
...
func (o *ProvidersTrailerInfo) SetParentIndexNumberNil() {
...
func (o *ProvidersTrailerInfo) SetPremiereDateNil() {
...
func (o ProvidersTrailerInfo) MarshalJSON() ([]byte, error) {
...
func (o ProvidersTrailerInfo) ToMap() (map[string]interface{}, error) {
...
type NullableProvidersTrailerInfo struct {
	value *ProvidersTrailerInfo
	isSet bool
}

func (v NullableProvidersTrailerInfo) Get() *ProvidersTrailerInfo {
	return v.value
}

func (v *NullableProvidersTrailerInfo) Set(val *ProvidersTrailerInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableProvidersTrailerInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableProvidersTrailerInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProvidersTrailerInfo(val *ProvidersTrailerInfo) *NullableProvidersTrailerInfo {
	return &NullableProvidersTrailerInfo{value: val, isSet: true}
}

func (v NullableProvidersTrailerInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProvidersTrailerInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
