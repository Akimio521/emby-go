...
func (r ApiGetOfficialratingsRequest) LocationTypes(locationTypes string) ApiGetOfficialratingsRequest {
	r.locationTypes = &locationTypes
	return r
}

// Optional. If specified, results will be filtered based on LocationType. This allows multiple, comma delimeted.
func (r ApiGetOfficialratingsRequest) ExcludeLocationTypes(excludeLocationTypes string) ApiGetOfficialratingsRequest {
	r.excludeLocationTypes = &excludeLocationTypes
	return r
}

// Optional filter by items that are missing episodes or not.
func (r ApiGetOfficialratingsRequest) IsMissing(isMissing bool) ApiGetOfficialratingsRequest {
...
func (r ApiGetOfficialratingsRequest) MinPremiereDate(minPremiereDate string) ApiGetOfficialratingsRequest {
	r.minPremiereDate = &minPremiereDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetOfficialratingsRequest) MinDateLastSaved(minDateLastSaved string) ApiGetOfficialratingsRequest {
	r.minDateLastSaved = &minDateLastSaved
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetOfficialratingsRequest) MinDateLastSavedForUser(minDateLastSavedForUser string) ApiGetOfficialratingsRequest {
	r.minDateLastSavedForUser = &minDateLastSavedForUser
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetOfficialratingsRequest) MaxPremiereDate(maxPremiereDate string) ApiGetOfficialratingsRequest {
