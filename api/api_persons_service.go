...
func (r ApiGetPersonsRequest) LocationTypes(locationTypes string) ApiGetPersonsRequest {
	r.locationTypes = &locationTypes
	return r
}

// Optional. If specified, results will be filtered based on LocationType. This allows multiple, comma delimeted.
func (r ApiGetPersonsRequest) ExcludeLocationTypes(excludeLocationTypes string) ApiGetPersonsRequest {
	r.excludeLocationTypes = &excludeLocationTypes
	return r
}

// Optional filter by items that are missing episodes or not.
func (r ApiGetPersonsRequest) IsMissing(isMissing bool) ApiGetPersonsRequest {
...
func (r ApiGetPersonsRequest) MinPremiereDate(minPremiereDate string) ApiGetPersonsRequest {
	r.minPremiereDate = &minPremiereDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MinDateLastSaved(minDateLastSaved string) ApiGetPersonsRequest {
	r.minDateLastSaved = &minDateLastSaved
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MinDateLastSavedForUser(minDateLastSavedForUser string) ApiGetPersonsRequest {
	r.minDateLastSavedForUser = &minDateLastSavedForUser
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetPersonsRequest) MaxPremiereDate(maxPremiereDate string) ApiGetPersonsRequest {
