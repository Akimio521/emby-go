...
// checks if the ProvidersRemoteSearchQueryProvidersGameInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvidersRemoteSearchQueryProvidersGameInfo{}

// ProvidersRemoteSearchQueryProvidersGameInfo struct for ProvidersRemoteSearchQueryProvidersGameInfo
...
func NewProvidersRemoteSearchQueryProvidersGameInfo() *ProvidersRemoteSearchQueryProvidersGameInfo {
	this := ProvidersRemoteSearchQueryProvidersGameInfo{}
	return &this
}
...
// SetSearchInfo gets a reference to the given ProvidersGameInfo and assigns it to the SearchInfo field.
...
func (o ProvidersRemoteSearchQueryProvidersGameInfo) MarshalJSON() ([]byte, error) {
...
func (o ProvidersRemoteSearchQueryProvidersGameInfo) ToMap() (map[string]interface{}, error) {
...
type NullableProvidersRemoteSearchQueryProvidersGameInfo struct {
	value *ProvidersRemoteSearchQueryProvidersGameInfo
	isSet bool
}

func (v NullableProvidersRemoteSearchQueryProvidersGameInfo) Get() *ProvidersRemoteSearchQueryProvidersGameInfo {
	return v.value
}

func (v *NullableProvidersRemoteSearchQueryProvidersGameInfo) Set(val *ProvidersRemoteSearchQueryProvidersGameInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableProvidersRemoteSearchQueryProvidersGameInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableProvidersRemoteSearchQueryProvidersGameInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProvidersRemoteSearchQueryProvidersGameInfo(val *ProvidersRemoteSearchQueryProvidersGameInfo) *NullableProvidersRemoteSearchQueryProvidersGameInfo {
	return &NullableProvidersRemoteSearchQueryProvidersGameInfo{value: val, isSet: true}
}

func (v NullableProvidersRemoteSearchQueryProvidersGameInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProvidersRemoteSearchQueryProvidersGameInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
