...
func (r ApiGetStudiosRequest) LocationTypes(locationTypes string) ApiGetStudiosRequest {
	r.locationTypes = &locationTypes
	return r
}

// Optional. If specified, results will be filtered based on LocationType. This allows multiple, comma delimeted.
func (r ApiGetStudiosRequest) ExcludeLocationTypes(excludeLocationTypes string) ApiGetStudiosRequest {
	r.excludeLocationTypes = &excludeLocationTypes
	return r
}

// Optional filter by items that are missing episodes or not.
func (r ApiGetStudiosRequest) IsMissing(isMissing bool) ApiGetStudiosRequest {
...
func (r ApiGetStudiosRequest) MinPremiereDate(minPremiereDate string) ApiGetStudiosRequest {
	r.minPremiereDate = &minPremiereDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetStudiosRequest) MinDateLastSaved(minDateLastSaved string) ApiGetStudiosRequest {
	r.minDateLastSaved = &minDateLastSaved
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetStudiosRequest) MinDateLastSavedForUser(minDateLastSavedForUser string) ApiGetStudiosRequest {
	r.minDateLastSavedForUser = &minDateLastSavedForUser
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetStudiosRequest) MaxPremiereDate(maxPremiereDate string) ApiGetStudiosRequest {
