...
// checks if the ProvidersBoxSetInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProvidersBoxSetInfo{}

// ProvidersBoxSetInfo struct for ProvidersBoxSetInfo
type ProvidersBoxSetInfo struct {
...
func (o *ProvidersBoxSetInfo) SetYearNil() {
	o.Year.Set(nil)
}
...
func (o *ProvidersBoxSetInfo) SetIndexNumberNil() {
...
func (o *ProvidersBoxSetInfo) SetParentIndexNumberNil() {
...
func (o *ProvidersBoxSetInfo) SetPremiereDateNil() {
...
func (o ProvidersBoxSetInfo) MarshalJSON() ([]byte, error) {
...
func (o ProvidersBoxSetInfo) ToMap() (map[string]interface{}, error) {
...
type NullableProvidersBoxSetInfo struct {
	value *ProvidersBoxSetInfo
	isSet bool
}

func (v NullableProvidersBoxSetInfo) Get() *ProvidersBoxSetInfo {
	return v.value
}

func (v *NullableProvidersBoxSetInfo) Set(val *ProvidersBoxSetInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableProvidersBoxSetInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableProvidersBoxSetInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProvidersBoxSetInfo(val *ProvidersBoxSetInfo) *NullableProvidersBoxSetInfo {
	return &NullableProvidersBoxSetInfo{value: val, isSet: true}
}

func (v NullableProvidersBoxSetInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProvidersBoxSetInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
