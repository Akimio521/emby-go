...
// GetCodecTimeBase returns the CodecTimeBase field value if set, zero value otherwise.
func (o *MediaStream) GetCodecTimeBase() string {
	if o == nil || IsNil(o.CodecTimeBase) {
		var ret string
		return ret
	}
	return *o.CodecTimeBase
}
...
// SetCodecTimeBase gets a reference to the given string and assigns it to the CodecTimeBase field.
...
func (o MediaStream) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.CodecTimeBase) {
		toSerialize["CodecTimeBase"] = o.CodecTimeBase
	}
	if !IsNil(o.Title) {
