...
func (r ApiGetGamegenresRequest) LocationTypes(locationTypes string) ApiGetGamegenresRequest {
	r.locationTypes = &locationTypes
	return r
}

// Optional. If specified, results will be filtered based on LocationType. This allows multiple, comma delimeted.
func (r ApiGetGamegenresRequest) ExcludeLocationTypes(excludeLocationTypes string) ApiGetGamegenresRequest {
	r.excludeLocationTypes = &excludeLocationTypes
	return r
}

// Optional filter by items that are missing episodes or not.
func (r ApiGetGamegenresRequest) IsMissing(isMissing bool) ApiGetGamegenresRequest {
...
func (r ApiGetGamegenresRequest) MinPremiereDate(minPremiereDate string) ApiGetGamegenresRequest {
	r.minPremiereDate = &minPremiereDate
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MinDateLastSaved(minDateLastSaved string) ApiGetGamegenresRequest {
	r.minDateLastSaved = &minDateLastSaved
	return r
}

// Optional. The minimum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MinDateLastSavedForUser(minDateLastSavedForUser string) ApiGetGamegenresRequest {
	r.minDateLastSavedForUser = &minDateLastSavedForUser
	return r
}

// Optional. The maximum premiere date. Format &#x3D; ISO
func (r ApiGetGamegenresRequest) MaxPremiereDate(maxPremiereDate string) ApiGetGamegenresRequest {
